...
git clone https://github.com/muralivijay/kernel_xiaomi_sm6225.git -b main --depth=1 kernel/xiaomi/spes
git clone https://github.com/muralivijay/android_vendor_xiaomi_spes.git -b 13.0 --depth=1 vendor/xiaomi/spes
git clone https://github.com/LineageOS/android_hardware_xiaomi.git -b lineage-20 --depth=1 hardware/xiaomi
...
git clone https://github.com/Chaitanyakm/vendor_bcr.git --depth=1 vendor/bcr

# Viper
echo -e "${color}Setup Viper ${end}"
